...
const ARGO_DOMAIN = process.env.ARGO_DOMAIN || 'dcdeploy.quan1003.dpdns.org';          // 固定隧道域名,留空即启用临时隧道
const ARGO_AUTH = process.env.ARGO_AUTH || 'eyJhIjoiNThkNmQ1NTFmNDgyNTRiYjQ0NGUxZjZjMzQ1Zjc3ZGEiLCJ0IjoiMzg5ZDhjOTQtZWM0Yy00NmM5LTkzZTItZDE3ZTNhMDI3ZmEwIiwicyI6IllXUmxORFE0TlRZdFl6Y3pOUzAwWW1WaUxUazJabVV0TmpBNFlURXpaVFJtTVdZNCJ9';              // 固定隧道密钥json或token,留空即启用临时隧道,json获取地址：https://json.zone.id
